...
#define TRAIN_FUNC_EXTERNAL_F29_F36 3
#define TRAIN_FUNC_EXTERNAL_F37_F44 4
#define TRAIN_FUNC_EXTERNAL_F45_F52 5
#define TRAIN_FUNC_EXTERNAL_F53_F60 6
#define TRAIN_FUNC_EXTERNAL_F61_F68 7
